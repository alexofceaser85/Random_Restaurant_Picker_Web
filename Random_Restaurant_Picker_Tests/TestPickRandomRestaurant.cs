...
namespace Random_Restaurant_Picker_Tests {
    ...
    public class TestPickRandomRestaurant {
        ...
        public void shouldAllowMinimumAndMaximumIndexAtMinimum() {
            ...
            Assert.AreEqual("Restaurant (name: Matt's Pizza price: $ location: Senoia GA hours: 9:00 - 5:00 distance: 5 review score: 4.5 review count: 5 menu URL: MenuURL.com image URL: ImageURL.com id: 5)", theManager.pickRandomRestaurant(0, 0).toString());
        }
        ...
        public void shouldAllowMinimumAndMaximumIndexOneAboveMinimum() {
            ...
            Assert.AreEqual("Restaurant (name: Katy Lou's price: $$$ location: Senoia GA hours: 8:00 - 6:00 distance: 0 review score: 4.9 review count: 3 menu URL: MenuURL.com image URL: ImageURL.com id: 6)", theManager.pickRandomRestaurant(1, 1).toString());
        }
        ...
        public void shouldAllowMinimumAndMaximumIndexWellAboveMinimum() {
            ...
            Restaurant firstRestaurant = new Random_Restaurant_Picker.Models.Restaurant("Matt's Pizza", "$", "Senoia GA", "9:00 - 5:00", 5, 4.5, 5, "MenuURL.com", "ImageURL.com", "5");
            Restaurant secondRestaurant = new Random_Restaurant_Picker.Models.Restaurant("Senoia Coffee", "$$", "Senoia GA", "9:00 - 2:00", 25, 5, 0, "MenuURL.com", "ImageURL.com", "7");
            Restaurant thirdRestaurant = new Random_Restaurant_Picker.Models.Restaurant("Beez Freeze", "$", "Senoia GA", "9:00 - 5:00", 5, 4.5, 5, "MenuURL.com", "ImageURL.com", "5");
            Restaurant fourthRestaurant = new Random_Restaurant_Picker.Models.Restaurant("Katy Lou's", "$$$", "Senoia GA", "8:00 - 6:00", 0, 4.9, 3, "MenuURL.com", "ImageURL.com", "6");
            Restaurant fifthRestaurant = new Random_Restaurant_Picker.Models.Restaurant("Mcdonalds", "$", "Senoia GA", "8:00 - 6:00", 0, 4.9, 3, "MenuURL.com", "ImageURL.com", "6");
            Restaurant sixthRestaurant = new Random_Restaurant_Picker.Models.Restaurant("The Dynasty", "$", "Newnan GA", "9:00 - 2:00", 25, 5, 0, "MenuURL.com", "ImageURL.com", "7");
            ...
            Assert.AreEqual("Restaurant (name: Katy Lou's price: $$$ location: Senoia GA hours: 8:00 - 6:00 distance: 0 review score: 4.9 review count: 3 menu URL: MenuURL.com image URL: ImageURL.com id: 6)", theManager.pickRandomRestaurant(3, 3).toString());
        }
    }
}
