...
namespace Random_Restaurant_Picker_Tests {
    ...
    public class TestRemoveRestaurant {
        ...
        public void shouldNotRemoveRestaurantFromManagerWithManyNotMatchingRestaurants() {
            ...
            Restaurant fourthRestaurant = new Random_Restaurant_Picker.Models.Restaurant("Jacob's Table", "$$", "Senoia GA", "9:00 - 2:00", 25, 5, 0, "MenuURL.com", "ImageURL.com", "8");
        ...
        public void shouldRemoveFirstRestaurantOfMany() {
            ...
            Assert.AreEqual("Restaurant (name: Katy Lou's price: $$$ location: Senoia GA hours: 8:00 - 6:00 distance: 0 review score: 4.9 review count: 3 menu URL: MenuURL.com image URL: ImageURL.com id: 6)\n"
                + "Restaurant (name: Senoia Coffee price: $$ location: Senoia GA hours: 9:00 - 2:00 distance: 25 review score: 5 review count: 0 menu URL: MenuURL.com image URL: ImageURL.com id: 7)\n", theManager.toString());
        }
